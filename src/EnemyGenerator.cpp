...
namespace EnemyGenerator{
    ...
    void initEnemies(){
        ...
        eGoblinScout->setActiveWeapon(ItemGenerator::cloneBalancedWeaponForMaterial(ItemGenerator::wKnife, materialBone));
        eGoblinScout->setMoveDelay(.5);

        eGoblinWarrior = new AiEntity ("Goblin Warrior", aiAttackPlayer, 'g', Point2Zero, Ui::C_DARK_GREEN, 75);
        eGoblinWarrior->setActiveWeapon(ItemGenerator::cloneBalancedWeaponForMaterial(ItemGenerator::wBattleAxe, materialBone));
